...
| POST | `/api/v1/admin/failed-paths-cache/clear` | Clear failed-path cache records and requeue matching cached failures (admin only; does not delete Nix store paths, logs, or build history) | 200 |
