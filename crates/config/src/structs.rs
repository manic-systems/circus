...
pub struct PageAccessConfig {
  ...
  pub caches:       PageAccessLevel,
  pub cache_detail: PageAccessLevel,
  pub cache_nars:   PageAccessLevel,
}
...
impl Default for PageAccessConfig {
  fn default() -> Self {
    Self {
      ...
      caches:       PageAccessLevel::Admin,
      cache_detail: PageAccessLevel::Admin,
      cache_nars:   PageAccessLevel::Admin,
    }
  }
}
