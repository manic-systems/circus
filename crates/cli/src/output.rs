...
pub(super) fn print_users(value: &Value) {
  print_table(
...
pub(super) fn print_pinned_outputs(value: &Value) {
  print_table(
...
pub(super) fn print_builds(value: &Value) {
  print_table(
    &[
...
pub(super) fn print_page(value: &Value) {
...
pub(super) fn search_rows(value: &Value) -> Vec<Vec<String>> {
