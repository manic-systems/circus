...
impl BufferMut {
  ...
  // In separate function to allow the short-circuits in `reserve` and
  // `try_reclaim` to be inline-able. Significantly helps performance. Returns
  ...
  /// Returns the remaining spare capacity of the buffer as a slice of
  /// `MaybeUninit<u8>`.
  ///
