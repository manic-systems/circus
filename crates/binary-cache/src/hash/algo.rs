...
/// A digest algorithm.
#[derive(
  Debug, PartialEq, Eq, PartialOrd, Ord, Clone, Copy, Hash, Display, Default,
)]
pub enum Algorithm {
  #[display("md5")]
  MD5,
...
mod tests {
  ...
  use super::*;
  use crate::{Hash, view::HashView as _};

  /// value taken from: https://tools.ietf.org/html/rfc1321
  const MD5_EMPTY: Hash =
    Hash::new(Algorithm::MD5, &hex!("d41d8cd98f00b204e9800998ecf8427e"));
  /// value taken from: https://tools.ietf.org/html/rfc1321
  const MD5_ABC: Hash =
    Hash::new(Algorithm::MD5, &hex!("900150983cd24fb0d6963f7d28e17f72"));
